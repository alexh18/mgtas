...
class ViewControllerEjercicio: UIViewController {
    ...
    @IBOutlet weak var sementoEjercicios: UISegmentedControl!
    ...
    @IBAction func segmentoEjercicio(_ sender: Any) {
    ...
    @IBAction func guardar(_ sender: Any) {
        ...
        if let dia = txtDia.text, let serie = txtSerie.text, let enfoque = txtEnfoque.text{
                
                if bandera == "Agregar"{
               saveEntityEjercicios(dia: dia , enfoque: enfoque, serie: serie)
